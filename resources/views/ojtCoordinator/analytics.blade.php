...
<head>
    ...
    <main class="page">
        ...
        @if(!empty($analyticsInsights))
            <div data-ai-insight-card class="bud-ai-insight-card" style="margin-top:18px;">
                <div class="bud-ai-header">
                    <div class="bud-ai-brand">
                        ...
                        <div class="bud-ai-title-wrap">
                            <h2>Bud AI Intelligence <span>• Institutional Analytics</span></h2>
                            <p>University-wide placement rates, modality distributions, and strategic recommendations</p>
                        </div>
                    </div>
                    @php
