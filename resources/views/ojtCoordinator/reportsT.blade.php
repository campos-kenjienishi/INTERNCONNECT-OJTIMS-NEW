                ...
                <div class="bud-ai-header">
                    <div class="bud-ai-brand">
                        ...
                        <div class="bud-ai-title-wrap">
                            <h2>Bud AI Intelligence <span>• Student OJT Report</span></h2>
                            <p>Cohort placement monitoring, requirement bottlenecks, and actionable guidance</p>
                        </div>
                    </div>
                    <div class="bud-ai-actions">
                        <button type="button" data-ai-insight-button data-ai-context="studentAiContext" data-ai-endpoint="{{ route('reports.ai.insight') }}" data-ai-token="{{ csrf_token() }}" class="bud-generate-btn">
