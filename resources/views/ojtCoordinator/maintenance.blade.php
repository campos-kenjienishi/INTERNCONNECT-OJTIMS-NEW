...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .table-card-body table.dataTable thead td {
        ...
        .table-card-body table.dataTable thead td:first-child {
            position: sticky;
            left: 0;
            z-index: 10;
        }
        ...
        body.dark-mode .table-card-body table.dataTable thead td {
        ...
        body.dark-mode .table-card-body table.dataTable thead td:first-child {
            background: #2a2a2a !important;
        }
        ...
        body.dark-mode .table-card-body table.dataTable tbody tr:hover td { background: rgba(220,38,38,0.1) !important; }
        body.dark-mode .table-card-body table.dataTable tbody tr:hover td:first-child { background: rgba(220,38,38,0.1) !important; }
        ...
        .course-name-text { font-weight: 600; color: #1a1a1a; font-size: 13px; }

        body.dark-mode .course-name-text { color: #fff !important; }
...
/* Modal */
        body.dark-mode .modal-body { background: #1a1a1a; color: #e8e8e8 !important; }
...
body.dark-mode .card { background: #2a2a2a; border: 1px solid #3a3a3a; }
        ...
        .swal2-popup { font-family: 'Poppins', sans-serif !important; border-radius: 16px !important; }
