...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/professor_studentRequire-responsive.css') }}">
...
.btn-back:hover {
    ...
    color: #fff; text-decoration: none;
        ...
        /* File name */
        .file-name-text { font-size: 12.5px; color: #666; }
...
<div class="main-content" id="mainContent">
    ...
    <div class="page-content">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                <div class="stat-icon blue"><i class="fa fa-times-circle"></i></div>
                <div>
