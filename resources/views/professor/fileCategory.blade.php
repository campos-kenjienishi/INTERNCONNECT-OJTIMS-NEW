...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/professor_fileReq-responsive.css') }}">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dataTables_filter input {
            ...
            font-size: 13px !important; outline: none !important; color: #333 !important; background: #fff !important;
        }
        ...
        .dataTables_paginate .paginate_button { border-radius: 6px !important; font-family: 'Poppins', sans-serif !important; font-size: 13px !important; padding: 4px 10px !important; color: #333 !important; background: #f5f5f5 !important; border-color: #ddd !important; }
        ...
        .cat-name-text { font-weight: 600; color: #1a1a1a; }
...
.dashboard-footer .divider {
    ...
    margin: 0 2px;
        ...
        body.dark-mode .breadcrumb a { color: var(--red); }

        body.dark-mode .stat-card { background: #2a2a2a; border: 1px solid #3a3a3a; }
        ...
        body.dark-mode .cat-count-badge { background: rgba(220,38,38,0.2) !important; color: #ff6b6b !important; }
