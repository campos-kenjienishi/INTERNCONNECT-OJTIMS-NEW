...
<div class="main-content" id="mainContent">
    ...
    <div class="page-content">
        ...
        <div data-ai-insight-card class="bud-ai-insight-card" style="margin-bottom:24px;">
            <div class="bud-ai-header">
                <div class="bud-ai-brand">
                    ...
                    <div class="bud-ai-title-wrap">
                        <h2>Bud AI Intelligence <span>• Faculty Analytics</span></h2>
                        <p>Class progress overview, requirement completion trends, and adviser action points</p>
                    </div>
                </div>
                @php
                ...
                <div class="bud-ai-actions">
                    <button type="button" data-ai-insight-button data-ai-context="analyticsAiContext" data-ai-endpoint="{{ route('reports.ai.insight') }}" data-ai-token="{{ csrf_token() }}" class="bud-generate-btn">
            ...
            <div data-ai-result-panel class="bud-ai-body" style="display:none;">
                ...
                <div data-ai-summary-card class="bud-ai-summary-card">
                    <p data-ai-summary style="margin:0; line-height:1.7;">{{ $analyticsInsights['summary'] ?? 'No insight available.' }}</p>
                </div>
        ...
        <!-- Section 1: Advising & Student Status -->
        <div class="analytics-section-title">
            <i class="fa fa-user-graduate"></i> Advising & Student Status
        </div>
        ...
        <!-- Section 2: Requirement & File Submissions -->
        <div class="analytics-section-title">
            <i class="fa fa-folder-open"></i> Requirement & File Submissions
        </div>
        ...
        <!-- Section 3: Overview & Standing -->
        <div class="analytics-section-title">
            <i class="fa fa-chart-pie"></i> Detailed Overview & Standing
        </div>
    ...
    <footer class="dashboard-footer">
        <div class="footer-inner" style="display:flex; align-items:center; gap:8px;">
    ...
    <div class="analytics-print" style="font-family:'Poppins',Arial,sans-serif; background:#fff; color:#111827;">
        ...
        <div style="background:#7f0000; padding:8px 22px; display:flex; align-items:center; justify-content:space-between; gap:10px; flex-wrap:wrap;">
            <div style="display:flex; align-items:center; gap:6px;">
                ...
                <span style="font-size:8px; color:rgba(255,255,255,.75); font-weight:500;">© 1998–{{ now()->year }} <strong style="color:#fca5a5;">Polytechnic University of the Philippines</strong> — Taguig Campus</span>
            </div>
            <div style="font-size:8px; color:rgba(255,255,255,.65);">InternConnect - OJTIMS &nbsp;|&nbsp; Ref: PROF-ANA-{{ now()->year }}</div>
        </div>
    </div>
</div>
...
<script src="{{ vasset('js/professor/analytics.js') }}?v={{ time() }}"></script>
