...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/professor_class-responsive.css') }}">
...
.btn-remove:hover { box-shadow: 0 6px 18px var(--btn-remove-glow); }
        ...
        body.dark-mode .room-count-badge { background: rgba(220,38,38,0.2) !important; color: #ff6b6b !important; }
        ...
        <div class="modal-content" style="border-radius:16px; overflow:hidden; border:none; box-shadow:0 20px 60px rgba(0,0,0,0.2);">
            ...
            <div class="modal-body" style="padding:0; background:#f8fafc;">
                <div style="padding:12px 18px; border-bottom:1px solid #e2e8f0; background:#fff; display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                    ...
                    <a id="filePreviewDownloadBtn" href="#" class="btn-template-download" style="padding:6px 14px; font-size:12px; text-decoration:none;">
