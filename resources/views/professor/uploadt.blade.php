...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .file-name-text { font-weight: 600; color: #1a1a1a; font-size: 13.5px; }
        .file-ext { font-size: 11px; color: #888; margin-top: 1px; }

        /* Uploader cell */
        .uploader-cell { display: flex; align-items: center; gap: 8px; }
        ...
        .file-drop-zone:hover { border-color: var(--red); background: #fff5f5; }
        ...
        .file-drop-zone .drop-icon {
            font-size: 28px; color: #ccc; margin-bottom: 8px;
            transition: color 0.25s;
        }

        .file-drop-zone:hover .drop-icon { color: var(--red); }
        .file-drop-zone p   { font-size: 13px; color: #888; margin: 0; }
        .file-drop-zone span { font-size: 12px; color: #bbb; }
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ url('/professor/upload') }}" class="nav-item active">
...
<div class="main-content" id="mainContent">
    ...
    <div class="page-content">
        ...
        <div class="page-header">
            ...
            <button class="btn-upload-new" data-bs-toggle="modal" data-bs-target="#uploadModal">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                <div class="stat-icon green"><i class="fa fa-file-word"></i></div>
                <div>
                    <div class="stat-num">DOC</div>
            ...
            <div class="table-card-header">
                <div class="table-card-header-left">
                    ...
                    <div>
                        ...
                        <p>Manage all OJT template files available for students to download</p>
                    </div>
                </div>
                <div class="file-count-badge">
                    <i class="fa fa-file"></i>
                    {{ count($data) }} {{ count($data) == 1 ? 'file' : 'files' }}
                </div>
            </div>
                ...
                <table id="fileTable" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color:#aaa; font-size:12px;">{{ $file->file }}</td>
                            <td>
                                <div class="uploader-cell">
                                    <div class="uploader-avatar"><i class="fa fa-user-tie"></i></div>
                                    {{ $file->uploader_name }}
                                </div>
                            </td>
                            <td>
                                <div class="date-main">{{ \Carbon\Carbon::parse($file->created_at)->format('M d, Y') }}</div>
                                <div class="date-sub">{{ \Carbon\Carbon::parse($file->created_at)->format('h:i A') }}</div>
                            </td>
                            <td>
                                <a href="{{ url('/download', $file->file) }}"
                                   class="btn-download" id="downloadBtn_{{ $file->id }}">
            ...
            <form id="uploadForm" action="{{ url('/uploadfile') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <label class="modal-field-label">
                        <i class="fa fa-tag"></i> File Name
                    </label>
                    <input class="modal-field-input" type="text" name="name"
                           placeholder="Enter a display name for this template">
                    ...
                    <div class="file-drop-zone" id="dropZone">
                        ...
                        <div class="drop-icon"><i class="fa fa-file-word"></i></div>
                        <p id="fileLabel">Click or drag a file here to upload</p>
                        <span>Accepted formats: .doc, .docx</span>
                    </div>
