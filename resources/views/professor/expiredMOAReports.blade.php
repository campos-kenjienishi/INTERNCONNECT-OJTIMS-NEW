                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select" name="school_year_end" id="school_year_end" required>
                            <!-- Default blank option -->
                            <option value="">Select Year</option>
                            <!-- Generate options for the end year dropdown -->
                        ...
                        <div class="table-container">
                            ...
                            <table id="companyTable" class="display">
                                ...
                                <tr>
                                    ...
                                    <td data-orderable="true">Start S.Y. Validity</td>
                                    {{-- <td>Student List</td> --}}
                                    <td>Status</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            // Calculate the difference between the current year and start year
                                            $difference = now()->year - $startYear;
                                
                                            // Determine if the MOA is expired (more than 3 years old)
