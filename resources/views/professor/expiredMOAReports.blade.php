                ...
                <div class="bud-ai-header">
                    <div class="bud-ai-brand">
                        ...
                        <div class="bud-ai-title-wrap">
                            <h2>Bud AI Intelligence <span>• MOA Insights</span></h2>
                            <p>Adviser MOA compliance analytics and active partnership recommendations</p>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr data-nature-of-bus="{{ $company->nature_of_bus ?? '' }}" data-date-notarized="{{ $dateNotarizedFormatted }}">
                            ...
                            <td class="company-rep-cell">
                                <div class="rep-wrap">
                                    <i class="fa fa-user-tie" style="color:var(--red);font-size:11px;flex-shrink:0;"></i>
